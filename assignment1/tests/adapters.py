...
import torch
from cs336_basics.tokenizer_train import train
from cs336_basics.BasicTokenizer import BasicTokenizer
...
def run_positionwise_feedforward(
    ...
    # ff.w1 = weights['w1.weight']
    # ff.w2 = weights['w2.weight']
...
def run_multihead_self_attention(
    ...
    """
    mha = MultiHeadAttention(d_model, num_heads, attn_pdrop)
...
def run_transformer_lm(
    ...
    """
    transformer = Transformer(vocab_size, context_length, d_model, num_layers, num_heads, d_ff, attn_pdrop, residual_pdrop)
...
def get_tokenizer(
    ...
    """
    return BasicTokenizer(vocab, merges, special_tokens)
